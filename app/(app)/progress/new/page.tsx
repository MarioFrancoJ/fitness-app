  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-500">Record your current body measurements.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6" noValidate>
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            <Input id="waist" type="number" label="Waist" placeholder="80" step={0.1} value={waist} onChange={(e) => setWaist(e.target.value)} />
            <Input id="chest" type="number" label="Chest" placeholder="100" step={0.1} value={chest} onChange={(e) => setChest(e.target.value)} />
            <Input id="hips" type="number" label="Hips" placeholder="95" step={0.1} value={hips} onChange={(e) => setHips(e.target.value)} />
            <Input id="neck" type="number" label="Neck" placeholder="38" step={0.1} value={neck} onChange={(e) => setNeck(e.target.value)} />
            <Input id="leftArm" type="number" label="Left Arm" placeholder="35" step={0.1} value={leftArm} onChange={(e) => setLeftArm(e.target.value)} />
            <Input id="rightArm" type="number" label="Right Arm" placeholder="35" step={0.1} value={rightArm} onChange={(e) => setRightArm(e.target.value)} />
            <Input id="leftLeg" type="number" label="Left Leg" placeholder="55" step={0.1} value={leftLeg} onChange={(e) => setLeftLeg(e.target.value)} />
            <Input id="rightLeg" type="number" label="Right Leg" placeholder="55" step={0.1} value={rightLeg} onChange={(e) => setRightLeg(e.target.value)} />
          </div>
        </div>
