...
function IconScale() { return <svg viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4" aria-hidden="true"><path fillRule="evenodd" d="M10 1.75a.75.75 0 0 1 .75.75v.317c1.63.2 3.06.79 4.06 1.2a.75.75 0 0 1 .44.96l-1.8 4.68a.75.75 0 0 1-.05.11 2.75 2.75 0 0 1-5.3 0 .75.75 0 0 1-.05-.11L6.9 6.09a13.6 13.6 0 0 0-1.9-.5l1.72 4.47a2.75 2.75 0 0 1-5.3 0 .75.75 0 0 1-.05-.11L.75 5.27a.75.75 0 0 1 .44-.96c1-.41 2.43-1 4.06-1.2V2.5a.75.75 0 0 1 1.5 0V3.1c.42-.04.83-.06 1.25-.06s.83.02 1.25.06V2.5a.75.75 0 0 1 .75-.75ZM9.25 4.6c-1.03.02-2 .18-2.86.4L4.35 15.5h11.3l-2.04-10.5c-.86-.22-1.83-.38-2.86-.4V15a.75.75 0 0 1-1.5 0V4.6ZM3.5 16.5a.75.75 0 0 0 0 1.5h13a.75.75 0 0 0 0-1.5h-13Z" clipRule="evenodd" /></svg>; }
